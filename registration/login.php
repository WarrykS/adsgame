...
if (isset($_POST['username'])){
  ...
  // récupère les lignes d'un jeu de resultats 
...
<h1 class="box-logo box-title"><img src="adsgame copy.png"><br> Adsgame</a></h1>
...
<p class="box-register"><a href="register.php" >Pas encore inscrit ?</a></p>
